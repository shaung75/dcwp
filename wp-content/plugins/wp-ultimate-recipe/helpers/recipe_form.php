...
<div class="recipe-video-container">
    ...
    <table class="recipe-general-form">
        <tr>
            ...
            <td class="recipe-general-form-field">
                <button type="button" class="button wpurp-recipe-video-add <?php echo $recipe->has_video() ? 'hidden' : ''; ?>"><?php esc_html_e( 'Upload Video', 'wp-recipe-maker' ); ?></button>
                <button type="button" class="button wpurp-recipe-video-remove <?php echo $recipe->has_video() ? '' : 'hidden'; ?>"><?php esc_html_e( 'Remove Video', 'wp-recipe-maker' ); ?></button>
