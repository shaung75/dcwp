...
function green_farm_get_admin_page() {
	global $pagenow;
...
function green_farm_default_tab() {
	$current_page = green_farm_get_admin_page();
...
function green_farm_get_the_tab() {
	global $pagenow;
	
	$default_tab = green_farm_default_tab();
...
function green_farm_settings_page_header() {
