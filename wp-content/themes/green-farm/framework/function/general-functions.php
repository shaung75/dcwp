...
/* Register CSS Styles */
function green_farm_register_css_styles() {
	if (!is_admin()) {
		global $post, 
			$wp_styles;
		...
		wp_enqueue_style('green-farm-theme-style', get_template_directory_uri() . '/style.css', array(), '1.0.0', 'screen, print');
		
		wp_enqueue_style('green-farm-style', get_template_directory_uri() . '/theme-framework/theme-style' . CMSMASTERS_THEME_STYLE . '/css/style.css', array(), '1.0.0', 'screen, print');
		
		wp_enqueue_style('green-farm-adaptive', get_template_directory_uri() . '/theme-framework/theme-style' . CMSMASTERS_THEME_STYLE . '/css/adaptive.css', array(), '1.0.0', 'screen, print');
		
		wp_enqueue_style('green-farm-retina', get_template_directory_uri() . '/theme-framework/theme-style' . CMSMASTERS_THEME_STYLE . '/css/retina.css', array(), '1.0.0', 'screen');
		
		
		if (is_rtl()) {
			wp_enqueue_style('green-farm-rtl', get_template_directory_uri() . '/theme-framework/theme-style' . CMSMASTERS_THEME_STYLE . '/css/rtl.css', array(), '1.0.0', 'screen');
		}
		...
		// iLightBox skins
		$ilightbox_skin = $cmsmasters_option['green-farm' . '_ilightbox_skin'];
		...
		if (is_dir($style_dir) && get_option('cmsmasters_style_exists_' . 'green-farm')) {
			$cmsmasters_styles_dir = $upload_dir['baseurl'] . '/cmsmasters_styles/';
		}
		
		
		wp_enqueue_style('green-farm-fonts-schemes', $cmsmasters_styles_dir . 'green-farm' . '.css', array(), '1.0.0', 'screen');
	}
}

add_action('wp_enqueue_scripts', 'green_farm_register_css_styles');



/* Register JS Scripts */
function green_farm_register_js_scripts() {
	global $post;
	...
	$cmsmasters_localize_array = array( 
		...
		'project_puzzle_proportion' => 			green_farm_project_puzzle_proportion(), 
		'gmap_api_key' => 						$cmsmasters_option['green-farm' . '_gmap_api_key'], 
		'gmap_api_key_notice' => 				esc_html__('Please add your Google Maps API key', 'green-farm'), 
		'gmap_api_key_notice_link' => 			esc_html__('read more how', 'green-farm'), 
		'primary_color' => 						$cmsmasters_option['green-farm' . '_default_link'], 
		'ilightbox_skin' => 					$cmsmasters_option['green-farm' . '_ilightbox_skin'], 
		'ilightbox_path' => 					$cmsmasters_option['green-farm' . '_ilightbox_path'], 
		'ilightbox_infinite' => 				$cmsmasters_option['green-farm' . '_ilightbox_infinite'], 
		'ilightbox_aspect_ratio' => 			$cmsmasters_option['green-farm' . '_ilightbox_aspect_ratio'], 
		'ilightbox_mobile_optimizer' => 		$cmsmasters_option['green-farm' . '_ilightbox_mobile_optimizer'], 
		'ilightbox_max_scale' => 				$cmsmasters_option['green-farm' . '_ilightbox_max_scale'], 
		'ilightbox_min_scale' => 				$cmsmasters_option['green-farm' . '_ilightbox_min_scale'], 
		'ilightbox_inner_toolbar' => 			$cmsmasters_option['green-farm' . '_ilightbox_inner_toolbar'], 
		'ilightbox_smart_recognition' => 		$cmsmasters_option['green-farm' . '_ilightbox_smart_recognition'], 
		'ilightbox_fullscreen_one_slide' => 	$cmsmasters_option['green-farm' . '_ilightbox_fullscreen_one_slide'], 
		'ilightbox_fullscreen_viewport' => 		$cmsmasters_option['green-farm' . '_ilightbox_fullscreen_viewport'], 
		'ilightbox_controls_toolbar' => 		$cmsmasters_option['green-farm' . '_ilightbox_controls_toolbar'], 
		'ilightbox_controls_arrows' => 			$cmsmasters_option['green-farm' . '_ilightbox_controls_arrows'], 
		'ilightbox_controls_fullscreen' => 		$cmsmasters_option['green-farm' . '_ilightbox_controls_fullscreen'], 
		'ilightbox_controls_thumbnail' => 		$cmsmasters_option['green-farm' . '_ilightbox_controls_thumbnail'], 
		'ilightbox_controls_keyboard' => 		$cmsmasters_option['green-farm' . '_ilightbox_controls_keyboard'], 
		'ilightbox_controls_mousewheel' => 		$cmsmasters_option['green-farm' . '_ilightbox_controls_mousewheel'], 
		'ilightbox_controls_swipe' => 			$cmsmasters_option['green-farm' . '_ilightbox_controls_swipe'], 
		'ilightbox_controls_slideshow' => 		$cmsmasters_option['green-farm' . '_ilightbox_controls_slideshow'], 
		'ilightbox_close_text' => 				esc_html__('Close', 'green-farm'), 
		'ilightbox_enter_fullscreen_text' => 	esc_html__('Enter Fullscreen (Shift+Enter)', 'green-farm'), 
		'ilightbox_exit_fullscreen_text' => 	esc_html__('Exit Fullscreen (Shift+Enter)', 'green-farm'), 
		'ilightbox_slideshow_text' => 			esc_html__('Slideshow', 'green-farm'), 
		'ilightbox_next_text' => 				esc_html__('Next', 'green-farm'), 
		'ilightbox_previous_text' => 			esc_html__('Previous', 'green-farm'), 
		'ilightbox_load_image_error' => 		esc_html__('An error occurred when trying to load photo.', 'green-farm'), 
		'ilightbox_load_contents_error' => 		esc_html__('An error occurred when trying to load contents.', 'green-farm'), 
		'ilightbox_missing_plugin_error' => 	esc_html__("The content your are attempting to view requires the <a href='{pluginspage}' target='_blank'>{type} plugin<\/a>.", 'green-farm') 
	);
	...
	wp_enqueue_script('green-farm-script', get_template_directory_uri() . '/js/jquery.script.js', array('jquery'), '1.0.0', true);
	
	wp_localize_script('green-farm-script', 'cmsmasters_script', $cmsmasters_localize_array);
	
	wp_enqueue_script('green-farm-theme-script', get_template_directory_uri() . '/theme-framework/theme-style' . CMSMASTERS_THEME_STYLE . '/js/jquery.theme-script.js', array('jquery', 'green-farm-script'), '1.0.0', true);
	...
	if ( 
		...
		isset($cmsmasters_option['green-farm' . '_gmap_api_key']) && 
		$cmsmasters_option['green-farm' . '_gmap_api_key'] != '' 
	) {
		wp_enqueue_script('gMapAPI', '//maps.googleapis.com/maps/api/js?key=' . $cmsmasters_option['green-farm' . '_gmap_api_key'], array('jquery'), '1.0.0', true);
	...
	$cmsmasters_custom_js = stripslashes($cmsmasters_option['green-farm' . '_custom_js']);
	
	wp_add_inline_script('green-farm-script', $cmsmasters_custom_js);
	
	
	if (CMSMASTERS_DEVELOPER_MODE) {
		green_farm_regenerate_styles();
	}
}

add_action('wp_enqueue_scripts', 'green_farm_register_js_scripts');



/* Google Fonts Generate Function */
if (!function_exists('green_farm_theme_google_fonts_generate')) {

function green_farm_theme_google_fonts_generate() {
	$cmsmasters_option = green_farm_get_global_options();
	...
	foreach (cmsmasters_google_fonts_list() as $key => $value) {
		if ( 
			(isset($cmsmasters_option['green-farm' . '_content_font_google_font']) && $key == $cmsmasters_option['green-farm' . '_content_font_google_font'] && $key != '') || 
			(isset($cmsmasters_option['green-farm' . '_link_font_google_font']) && $key == $cmsmasters_option['green-farm' . '_link_font_google_font'] && $key != '') || 
			(isset($cmsmasters_option['green-farm' . '_nav_title_font_google_font']) && $key == $cmsmasters_option['green-farm' . '_nav_title_font_google_font'] && $key != '') || 
			(isset($cmsmasters_option['green-farm' . '_nav_dropdown_font_google_font']) && $key == $cmsmasters_option['green-farm' . '_nav_dropdown_font_google_font'] && $key != '') || 
			(isset($cmsmasters_option['green-farm' . '_h1_font_google_font']) && $key == $cmsmasters_option['green-farm' . '_h1_font_google_font'] && $key != '') || 
			(isset($cmsmasters_option['green-farm' . '_h2_font_google_font']) && $key == $cmsmasters_option['green-farm' . '_h2_font_google_font'] && $key != '') || 
			(isset($cmsmasters_option['green-farm' . '_h3_font_google_font']) && $key == $cmsmasters_option['green-farm' . '_h3_font_google_font'] && $key != '') || 
			(isset($cmsmasters_option['green-farm' . '_h4_font_google_font']) && $key == $cmsmasters_option['green-farm' . '_h4_font_google_font'] && $key != '') || 
			(isset($cmsmasters_option['green-farm' . '_h5_font_google_font']) && $key == $cmsmasters_option['green-farm' . '_h5_font_google_font'] && $key != '') || 
			(isset($cmsmasters_option['green-farm' . '_h6_font_google_font']) && $key == $cmsmasters_option['green-farm' . '_h6_font_google_font'] && $key != '') || 
			(isset($cmsmasters_option['green-farm' . '_button_font_google_font']) && $key == $cmsmasters_option['green-farm' . '_button_font_google_font'] && $key != '') || 
			(isset($cmsmasters_option['green-farm' . '_small_font_google_font']) && $key == $cmsmasters_option['green-farm' . '_small_font_google_font'] && $key != '') || 
			(isset($cmsmasters_option['green-farm' . '_input_font_google_font']) && $key == $cmsmasters_option['green-farm' . '_input_font_google_font'] && $key != '') || 
			(isset($cmsmasters_option['green-farm' . '_quote_font_google_font']) && $key == $cmsmasters_option['green-farm' . '_quote_font_google_font'] && $key != '') 
		) {
			$keys[] = $key;
		}
	}
...
add_action('wp_enqueue_scripts', 'green_farm_theme_google_fonts_generate');
...
function green_farm_get_google_font($font) {
	if ($font != '') {
		if (strpos($font, ':')) {
...
function green_farm_the_widgets_init() {
    ...
    register_sidebar(
        array(
            'name' => esc_html__('Sidebar', 'green-farm'), 
            'id' => 'sidebar_default', 
            'description' => esc_html__('Widgets in this area will be shown in all left and right sidebars till you don\'t use custom sidebar.', 'green-farm'), 
    ...
    register_sidebar(
        array(
            'name' => esc_html__('Bottom Sidebar', 'green-farm'), 
            'id' => 'sidebar_bottom', 
            'description' => esc_html__('Widgets in this area will be shown at the bottom of middle block below the content and middle sidebar, but above footer.', 'green-farm'), 
            'before_widget' => '<aside id="%1$s" class="widget %2$s">', 
            'after_widget' => '</aside>', 
            'before_title' => '<h3 class="widgettitle">', 
            'after_title' => '</h3>'
    ...
    register_sidebar(
        array(
            'name' => esc_html__('Archive Sidebar', 'green-farm'), 
            'id' => 'sidebar_archive', 
            'description' => esc_html__('Widgets in this area will be shown in all left and right sidebars on archives pages.', 'green-farm'), 
            'before_widget' => '<aside id="%1$s" class="widget %2$s">', 
            'after_widget' => '</aside>', 
            'before_title' => '<h3 class="widgettitle">', 
            'after_title' => '</h3>'
    ...
    register_sidebar(
        array(
            'name' => esc_html__('Search Sidebar', 'green-farm'), 
            'id' => 'sidebar_search', 
            'description' => esc_html__('Widgets in this area will be shown in left or right sidebar on search page.', 'green-farm'), 
            'before_widget' => '<aside id="%1$s" class="widget %2$s">', 
            'after_widget' => '</aside>', 
            'before_title' => '<h3 class="widgettitle">', 
            'after_title' => '</h3>'
	...
	if (isset($cmsmasters_option['green-farm' . '_sidebar']) && sizeof($cmsmasters_option['green-farm' . '_sidebar']) > 0) {
		foreach ($cmsmasters_option['green-farm' . '_sidebar'] as $sidebar) {
			register_sidebar(array( 
				'name' => $sidebar, 
				'id' => generateSlug($sidebar, 45), 
				'description' => esc_html__('Custom sidebar created with cmsmasters admin panel.', 'green-farm'), 
				'before_widget' => '<aside id="%1$s" class="widget %2$s">', 
				'after_widget' => '</aside>', 
				'before_title' => '<h3 class="widgettitle">', 
				'after_title' => '</h3>' 
...
add_action('widgets_init', 'green_farm_the_widgets_init');



/* Register Showing Home Page on Default WordPress Pages Menu */
function green_farm_page_menu_args($args) {
    $args['show_home'] = true;
...
add_filter('wp_page_menu_args', 'green_farm_page_menu_args');
...
if (function_exists('add_theme_support')) {
	...
	function green_farm_add_post_type_support_project($post) {
	...
	add_action('load-post.php', 'green_farm_add_post_type_support_project');
	
	add_action('load-post-new.php', 'green_farm_add_post_type_support_project');
	...
	add_filter('image_size_names_choose', 'green_farm_select_image_size');
}



/* Add Image Thumbnails Size to the List */
function green_farm_select_image_size($sizes) {
	$thumbnail_list = cmsmasters_image_thumbnail_list();
...
function green_farm_add_editor_styles() {
...
add_action('init', 'green_farm_add_editor_styles');



/* Register Removing 'More Text' From Excerpt */
function green_farm_new_excerpt_more($more) {
	return '...';
}

add_filter('excerpt_more', 'green_farm_new_excerpt_more');
...
function green_farm_excerpt($length = 55, $show = true) {
	if ($show) {
...
function green_farm_post_author_archive($query) {
...
add_action('pre_get_posts', 'green_farm_post_author_archive');



/* Check Row p Wrapper */
function green_farm_rowcheck($content) {
...
function green_farm_generate_front_css() {
	$shortcodes_css = get_post_meta(get_the_ID(), 'cmsmasters_shortcodes_custom_css', true);
	
	
	wp_add_inline_style('green-farm-retina', $shortcodes_css);
}

add_action('wp_enqueue_scripts', 'green_farm_generate_front_css');
...
function green_farm_add_global_icons() {
	...
	if ($wp_filesystem) {
		...
		update_option('cmsmasters_' . 'green-farm' . '_icons', serialize($arr));
		
		update_option('cmsmasters_' . 'green-farm' . '_icons_custom', serialize($arr_custom));
	}
}
...
function cmsmasters_composer_icons() {
	...
	if ( 
		...
		$icons = get_option('cmsmasters_' . 'green-farm' . '_icons');
		
		$icons_custom = get_option('cmsmasters_' . 'green-farm' . '_icons_custom');
		...
		} elseif (wp_script_is('green-farm-lightbox-js', 'queue')) {
			wp_add_inline_script('green-farm-lightbox-js', $out, 'before');
		}
	}
}
...
function green_farm_regenerate_styles() {
	$custom_css_fonts = green_farm_theme_fonts();
	
	$custom_css_colors_primary = green_farm_theme_colors_primary();
	
	$custom_css_colors_secondary = green_farm_theme_colors_secondary();
	
	
	$custom_css = $custom_css_fonts . $custom_css_colors_primary . $custom_css_colors_secondary;
	
	
	green_farm_write_styles($custom_css);
}



/* Write Custom Styles to File Function */
function green_farm_write_styles($styles, $filename = '') {
	$upload_dir = wp_upload_dir();
	...
	$is_dir = green_farm_create_folder($style_dir);
	
	
	if ($is_dir === false) {
		update_option('cmsmasters_style_dir_writable_' . 'green-farm', 'false');
		
		update_option('cmsmasters_style_exists_' . 'green-farm', 'false');
	...
	$file = trailingslashit($style_dir) . (($filename != '') ? $filename : 'green-farm') . '.css';
	
	
	$created = green_farm_create_file($file, $styles);
	
	
	if ($created === true) {
		update_option('cmsmasters_style_dir_writable_' . 'green-farm', 'true');
		
		update_option('cmsmasters_style_exists_' . 'green-farm', 'true');
	}
}
...
function green_farm_create_folder(&$folder, $addindex = true) {
...
function green_farm_create_file($file, $content = '', $verifycontent = true) {
	global $wp_filesystem;
...
function cmsmasters_get_tweets($username, $count) {
	...
	$numTweets = $count;
	$cacheTime = 1;
	$backupName = 'cmsmasters_' . 'green-farm' . '_tweets_list_backup';
	
	
	$connection = new TwitterOAuth( 
		(($cmsmasters_option['green-farm' . '_api_key'] != '') ? $cmsmasters_option['green-farm' . '_api_key'] : ''), 
		(($cmsmasters_option['green-farm' . '_api_secret'] != '') ? $cmsmasters_option['green-farm' . '_api_secret'] : ''), 
		(($cmsmasters_option['green-farm' . '_access_token'] != '') ? $cmsmasters_option['green-farm' . '_access_token'] : ''), 
		(($cmsmasters_option['green-farm' . '_access_token_secret'] != '') ? $cmsmasters_option['green-farm' . '_access_token_secret'] : '')
	);
...
function green_farm_theme_bg_styles() {
	global $post;
	...
	if ($cmsmasters_option['green-farm' . '_theme_layout'] == 'boxed') {
		...
		if ($cmsmasters_bg_default == 'false') {
			...
			$cmsmasters_bg_col = $cmsmasters_option['green-farm' . '_bg_col'];
			$cmsmasters_bg_img_enable = $cmsmasters_option['green-farm' . '_bg_img_enable'];
			$cmsmasters_bg_img_str = $cmsmasters_option['green-farm' . '_bg_img'];
			$cmsmasters_bg_pos = $cmsmasters_option['green-farm' . '_bg_pos'];
			$cmsmasters_bg_rep = $cmsmasters_option['green-farm' . '_bg_rep'];
			$cmsmasters_bg_att = $cmsmasters_option['green-farm' . '_bg_att'];
			$cmsmasters_bg_size = $cmsmasters_option['green-farm' . '_bg_size'];
		}
	...
	wp_add_inline_style('green-farm-style', $out);
}

add_action('wp_enqueue_scripts', 'green_farm_theme_bg_styles');



/* Get Logo Function */
function green_farm_logo() {
	$cmsmasters_option = green_farm_get_global_options();
	
	
	if ($cmsmasters_option['green-farm' . '_logo_type'] == 'text') {
		if ($cmsmasters_option['green-farm' . '_logo_title'] != '') {
			$blog_title = $cmsmasters_option['green-farm' . '_logo_title'];
		} else {
			$blog_title = (get_bloginfo('name')) ? get_bloginfo('name') : 'Green Farm';
		}
		
		
		if ($cmsmasters_option['green-farm' . '_logo_subtitle'] != '') {
			$blog_descr = $cmsmasters_option['green-farm' . '_logo_subtitle'];
		} else {
			$blog_descr = (get_bloginfo('description')) ? get_bloginfo('description') : esc_html__('Default Logo Subtitle', 'green-farm');
		}
		...
		echo '<a href="' . esc_url(home_url('/')) . '" title="' . esc_attr($blog_title) . '" class="logo">' . "\n\t" . 
			'<span class="logo_text_wrap">' . 
				...
				($cmsmasters_option['green-farm' . '_logo_subtitle'] ? '<span class="title_text">' . esc_html($blog_descr) . '</span>' : '') . 
			'</span>' . 
		'</a>';
	} else {
		...
		if ($cmsmasters_option['green-farm' . '_logo_url'] == '') {
			...
			$logo_img = explode('|', $cmsmasters_option['green-farm' . '_logo_url']);
			...
			if ($cmsmasters_option['green-farm' . '_logo_url_retina'] != '') {
				$logo_img_retina = explode('|', $cmsmasters_option['green-farm' . '_logo_url_retina']);
...
/* Logo Styles */
function green_farm_theme_logo_styles() {
	$cmsmasters_option = green_farm_get_global_options();
	...
	if ($cmsmasters_option['green-farm' . '_logo_type'] == 'text') {
		if ($cmsmasters_option['green-farm' . '_logo_custom_color']) {
			$out .= "
				#header a.logo span.title {
					" . cmsmasters_color_css('color', $cmsmasters_option['green-farm' . '_logo_title_color']) . "
				}
				
				#header a.logo span.title_text {
					" . cmsmasters_color_css('color', $cmsmasters_option['green-farm' . '_logo_subtitle_color']) . "
				}
			";
		}
	} else {
		...
		$header_mid_height = (($cmsmasters_option['green-farm' . '_header_mid_height'] !== '') ? $cmsmasters_option['green-farm' . '_header_mid_height'] : $defaults[$tab]['green-farm' . '_header_mid_height']);
...
add_action('wp_enqueue_scripts', 'green_farm_theme_logo_styles');



/* Get Footer Logo Function */
function green_farm_footer_logo($cmsmasters_option) {
	...
	if ($cmsmasters_option['green-farm' . '_footer_logo_url'] == '') {
		...
		$footer_logo_img = explode('|', $cmsmasters_option['green-farm' . '_footer_logo_url']);
		...
		if ($cmsmasters_option['green-farm' . '_footer_logo_url_retina'] != '') {
			$footer_logo_img_retina = explode('|', $cmsmasters_option['green-farm' . '_footer_logo_url_retina']);
...
function green_farm_social_icons() {
	$out = '';
...
<div class=\"social_wrap\">
	<div class=\"social_wrap_inner\">
		...
		foreach ($cmsmasters_option['green-farm' . '_social_icons'] as $cmsmasters_social_icons) {
...
function green_farm_get_comments($class = false, $show = false, $add_html = false) { 
	$out = '';
	
	if ($add_html) {
		$text = (get_comments_number() == '1') ? esc_html__('comment', 'green-farm') : esc_html__('comments', 'green-farm');
	} else {
		$text = '';
	}
	...
	if (comments_open()) {
		$out .= '<span class="cmsmasters_comments' . ($class ? ' ' . $class : '') . '">' . 
			'<a class="cmsmasters_theme_icon_comment" href="' . esc_url(get_comments_link()) . '" title="' . esc_attr__('Comment on', 'green-farm') . ' ' . esc_attr(get_the_title()) . '">' . 
...
/* Get Category List */
function green_farm_get_the_category_list($cmsmasters_id, $taxonomy, $sep = '', $before = '', $after = '', $taxonomy_class = false) {
...
function green_farm_theme_page_layout_scheme() {
	$cmsmasters_option = green_farm_get_global_options();
	...
	} elseif (CMSMASTERS_TRIBE_EVENTS && tribe_is_event_query() && isset($cmsmasters_option['green-farm' . '_events_layout'])) {
		$cmsmasters_layout = $cmsmasters_option['green-farm' . '_events_layout'];
	} elseif (is_archive() || is_home()) {
		$cmsmasters_layout = $cmsmasters_option['green-farm' . '_archives_layout'];
	} elseif (is_search()) {
		$cmsmasters_layout = $cmsmasters_option['green-farm' . '_search_layout'];
	} else {
		$cmsmasters_layout = $cmsmasters_option['green-farm' . '_other_layout'];
	}
	
	
	if ($cmsmasters_layout == '') {
		$cmsmasters_layout = $cmsmasters_option['green-farm' . '_layout'];
	}
...
function green_farm_global_shortcodes_styles_move($content) {
	return preg_replace("/(?<!['\"])<style.*?>([^`]*?)<\/style>/", '', $content);
}


function green_farm_row_checker($data) {
	$out = green_farm_rowcheck($data);
	
	return $out;
}

add_filter('the_content', 'green_farm_row_checker', 10, 2);
	...
	if( wp_verify_nonce($nonce, 'cmsmasters_ajax_like-nonce') ){
		...
		if ($post_ID != '') {
			...
			if (isset($_COOKIE['like-' . $post_ID]) || count($ipCheck) != 0) {
				...
				if ($add_html == 'true') {
					$text = ($plusLike == '1') ? esc_html__('like', 'green-farm') : esc_html__('likes', 'green-farm');
				} else {
					$text = '';
				}
...
function cmsmasters_ajax_apply_theme_style_callback() {
	...
	if (wp_verify_nonce($nonce, 'cmsmasters_ajax_apply_theme_style-nonce')) {
		if (isset($_POST['theme_style'])) {
			update_option('cmsmasters_green-farm_theme_style', $_POST['theme_style']);
		}
...
function green_farm_theme_style_change() {
	if (get_option('cmsmasters_options_green-farm' . CMSMASTERS_THEME_STYLE . '_theme_style')) {
		return;
	} else {
		green_farm_add_global_options();
		
		green_farm_add_global_icons();
		
		green_farm_regenerate_styles();
	}
}

add_action('init', 'green_farm_theme_style_change');
...
function cmsmasters_ajax_reset_settings_callback() {
	...
	if (wp_verify_nonce($nonce, 'cmsmasters_ajax_reset_settings-nonce')) {
		green_farm_add_global_options(true);
...
function cmsmasters_ajax_export_settings_callback() {
	...
	if (wp_verify_nonce($nonce, 'cmsmasters_ajax_export_settings-nonce')) {
		$cmsmasters_global_settings = array( 
			'cmsmasters_options_' . 'green-farm' . CMSMASTERS_THEME_STYLE . '_general', 
			'cmsmasters_options_' . 'green-farm' . CMSMASTERS_THEME_STYLE . '_bg', 
			'cmsmasters_options_' . 'green-farm' . CMSMASTERS_THEME_STYLE . '_header', 
			'cmsmasters_options_' . 'green-farm' . CMSMASTERS_THEME_STYLE . '_content', 
			'cmsmasters_options_' . 'green-farm' . CMSMASTERS_THEME_STYLE . '_footer', 
			'cmsmasters_options_' . 'green-farm' . CMSMASTERS_THEME_STYLE . '_font_content', 
			'cmsmasters_options_' . 'green-farm' . CMSMASTERS_THEME_STYLE . '_font_link', 
			'cmsmasters_options_' . 'green-farm' . CMSMASTERS_THEME_STYLE . '_font_nav', 
			'cmsmasters_options_' . 'green-farm' . CMSMASTERS_THEME_STYLE . '_font_heading', 
			'cmsmasters_options_' . 'green-farm' . CMSMASTERS_THEME_STYLE . '_font_other', 
			'cmsmasters_options_' . 'green-farm' . CMSMASTERS_THEME_STYLE . '_element_sidebar', 
			'cmsmasters_options_' . 'green-farm' . CMSMASTERS_THEME_STYLE . '_element_icon', 
			'cmsmasters_options_' . 'green-farm' . CMSMASTERS_THEME_STYLE . '_element_lightbox', 
			'cmsmasters_options_' . 'green-farm' . CMSMASTERS_THEME_STYLE . '_element_sitemap', 
			'cmsmasters_options_' . 'green-farm' . CMSMASTERS_THEME_STYLE . '_element_error', 
			'cmsmasters_options_' . 'green-farm' . CMSMASTERS_THEME_STYLE . '_element_code', 
			'cmsmasters_options_' . 'green-farm' . CMSMASTERS_THEME_STYLE . '_element_recaptcha', 
			'cmsmasters_options_' . 'green-farm' . CMSMASTERS_THEME_STYLE . '_single_post', 
			'cmsmasters_options_' . 'green-farm' . CMSMASTERS_THEME_STYLE . '_single_project', 
			'cmsmasters_options_' . 'green-farm' . CMSMASTERS_THEME_STYLE . '_single_profile'
		);
		...
		foreach (green_farm_all_color_schemes_list() as $key => $value) {
			$cmsmasters_global_colors[] = 'cmsmasters_options_' . 'green-farm' . CMSMASTERS_THEME_STYLE . '_color_' . $key;
		}
