...
<?php green_farm_get_header_search_form($cmsmasters_option); ?>

<!-- Start Page -->
<div id="page" class="<?php green_farm_get_page_classes($cmsmasters_option); ?>hfeed site">
...
<header id="header"<?php 
	if ($cmsmasters_option['green-farm' . '_header_styles'] == 'fullwidth') {
...
<div id="middle">
<?php 
green_farm_page_heading();


list($cmsmasters_layout, $cmsmasters_page_scheme) = green_farm_theme_page_layout_scheme();
