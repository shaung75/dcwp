...
function green_farm_woocommerce_colors($custom_css) {
...
/***************** Start {$title} WooCommerce Color Scheme Rules ******************/
	...
	{$rule}.link_hover_color {
		" . cmsmasters_color_css('border-color', $cmsmasters_option['green-farm' . '_' . $scheme . '_hover']) . "
	}
	
	{$rule}.cmsmasters_star_rating .cmsmasters_star_trans_wrap {
		color:rgba(" . cmsmasters_color2rgb($cmsmasters_option['green-farm' . '_' . $scheme . '_hover']) . ", 0.5);
	}
	...
	{$rule}.cmsmasters_product .button_to_cart_wrap:before, 
...
add_filter('green_farm_theme_colors_secondary_filter', 'green_farm_woocommerce_colors');
