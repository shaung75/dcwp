...
/* General Settings */
function green_farm_tribe_events_options_general_fields($options, $tab) {
	$new_options = array();
	
	if ($tab == 'content') {
		foreach($options as $option) {
			if ($option['id'] == 'green-farm_search_layout') {
				$new_options[] = $option;
				
				$new_options[] = array( 
					'section' => 'content_section', 
					'id' => 'green-farm' . '_events_layout', 
					'title' => esc_html__('Events Calendar Layout Type', 'green-farm'), 
					'desc' => '', 
					'type' => 'radio_img', 
					'std' => 'fullwidth', 
					'choices' => array( 
...
add_filter('cmsmasters_options_general_fields_filter', 'green_farm_tribe_events_options_general_fields', 10, 2);
