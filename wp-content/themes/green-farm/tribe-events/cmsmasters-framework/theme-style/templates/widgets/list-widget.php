...
if ( $posts ) : ?>
		...
		foreach ( $posts as $post ) :
			...
			<li class="tribe-events-list-widget-events <?php tribe_events_event_classes() ?>">
				...
				<div class="cmsmasters_events_more">
					<a href="<?php echo esc_url( tribe_get_event_link() ); ?>" class="tribe-events-read-more button" rel="bookmark"><?php esc_html_e( 'Find out more', 'green-farm' ) ?></a>
				</div>
			</li>
		<?php
		endforeach;
	...
	<p class="tribe-events-widget-link">
		<a href="<?php echo esc_url( tribe_get_events_link() ); ?>" rel="bookmark"><?php printf( esc_html__( 'View All %s', 'green-farm' ), $events_label_plural ); ?></a>
	</p>

<?php
// No events were found.
else : ?>
	<p><?php printf( esc_html__( 'There are no upcoming %s at this time.', 'green-farm' ), strtolower( $events_label_plural ) ); ?></p>
<?php
endif;
