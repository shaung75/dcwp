...
function green_farm_theme_colors_primary() {
...
/***************** Start {$title} Color Scheme Rules ******************/
	...
	{$rule}.cmsmasters_quote_subtitle_wrap .cmsmasters_quote_subtitle {
		" . cmsmasters_color_css('color', $cmsmasters_option['green-farm' . '_' . $scheme . '_color']) . "
	}
	
	{$rule}.custom_subscribe .wysija-input {
		background-color:rgba(" . cmsmasters_color2rgb($cmsmasters_option['green-farm' . '_' . $scheme . '_color']) . ", 0.08) !important;
	}
	...
	{$rule}.cmsmasters_header_search_form button {
		" . cmsmasters_color_css('color', $cmsmasters_option['green-farm' . '_' . $scheme . '_link']) . "
	}
	...
	{$rule}.cmsmasters-form-builder .check_parent input[type=radio] + label:after {
		" . cmsmasters_color_css('background-color', $cmsmasters_option['green-farm' . '_' . $scheme . '_link']) . "
	}
	...
	{$rule}.cmsmasters_counters .cmsmasters_counter_wrap .cmsmasters_counter .cmsmasters_counter_inner:before, 
	{$rule}#page input:not([type=submit]):not([type=button]):not([type=radio]):not([type=checkbox]):focus,
	{$rule}select:focus,
	{$rule}textarea:focus {
		" . cmsmasters_color_css('border-color', $cmsmasters_option['green-farm' . '_' . $scheme . '_link']) . "
	}
	
	{$rule}.cmsmasters_project_puzzle .project_outer:hover .project_inner {
		background-color:rgba(" . cmsmasters_color2rgb($cmsmasters_option['green-farm' . '_' . $scheme . '_link']) . ", 0.9);
	}
	
	{$rule}.post.cmsmasters_post_puzzle:hover .puzzle_post_content_wrapper {
		-webkit-box-shadow:inset 0 0 0 1px " . $cmsmasters_option['green-farm' . '_' . $scheme . '_link'] . ";
		box-shadow:inset 0 0 0 1px " . $cmsmasters_option['green-farm' . '_' . $scheme . '_link'] . ";
	}
	...
	{$rule}#page .sticky:before {
		" . cmsmasters_color_css('color', $cmsmasters_option['green-farm' . '_' . $scheme . '_hover']) . "
	}
	...
	{$rule}.cmsmasters_slider_post .cmsmasters_slider_post_content {
		" . cmsmasters_color_css('color', $cmsmasters_option['green-farm' . '_' . $scheme . '_heading']) . "
	}
	
	" . (($scheme == 'default') ? ".headline_outer," : '') . "
	{$rule}.cmsmasters_featured_block_hover:before, 
	{$rule}.cmsmasters_hover_slider .cmsmasters_hover_slider_thumbs a:before,
	{$rule}form .formError .formErrorContent {
		" . cmsmasters_color_css('background-color', $cmsmasters_option['green-farm' . '_' . $scheme . '_heading']) . "
	}
	
	{$rule}.cmsmasters_header_search_form {
		background-color:rgba(" . cmsmasters_color2rgb($cmsmasters_option['green-farm' . '_' . $scheme . '_heading']) . ", 0.95);
	}
	
	{$rule}.cmsmasters_profile .cmsmasters_img_rollover_wrap:hover .cmsmasters_img_rollover {
		background-color:rgba(" . cmsmasters_color2rgb($cmsmasters_option['green-farm' . '_' . $scheme . '_heading']) . ", 0.8);
	}
	
	{$rule}.post.cmsmasters_post_puzzle .preloader:after {
		background-color:rgba(" . cmsmasters_color2rgb($cmsmasters_option['green-farm' . '_' . $scheme . '_heading']) . ", 0.6);
	}
	...
	{$rule}.cmsmasters_icon_box.cmsmasters_icon_box_left:before,
	{$rule}.cmsmasters_icon_box.cmsmasters_icon_box_top:before {
		" . cmsmasters_color_css('color', $cmsmasters_option['green-farm' . '_' . $scheme . '_bg']) . "
	}
	...
	{$rule}.cmsmasters-form-builder .check_parent input[type=radio] + label:before {
		" . cmsmasters_color_css('background-color', $cmsmasters_option['green-farm' . '_' . $scheme . '_bg']) . "
	}
	
	{$rule}.post.cmsmasters_post_puzzle .puzzle_post_content_wrapper:before {
		" . cmsmasters_color_css('border-color', $cmsmasters_option['green-farm' . '_' . $scheme . '_bg']) . "
	}
	...
	{$rule}.cmsmasters_breadcrumbs {
		color:rgba(" . cmsmasters_color2rgb($cmsmasters_option['green-farm' . '_' . $scheme . '_bg']) . ", 0.7);
	}
	...
	{$rule}.cmsmasters_project_grid .cmsmasters_img_rollover_wrap:hover .cmsmasters_img_rollover {
		background-color:rgba(" . cmsmasters_color2rgb($cmsmasters_option['green-farm' . '_' . $scheme . '_bg']) . ", 0.98);
	}
	...
	{$rule}.cmsmasters_counters .cmsmasters_counter_wrap .cmsmasters_counter .cmsmasters_counter_inner:before {
		" . cmsmasters_color_css('color', $cmsmasters_option['green-farm' . '_' . $scheme . '_alternate']) . "
	}
	...
	{$rule}#page .sticky:before	{
		" . cmsmasters_color_css('background-color', $cmsmasters_option['green-farm' . '_' . $scheme . '_alternate']) . "
	}
	...
	{$rule}.cmsmasters_post_timeline .cmsmasters_post_day {
		" . cmsmasters_color_css('color', $cmsmasters_option['green-farm' . '_' . $scheme . '_border']) . "
	}
	...
	{$rule}.cmsmasters_sitemap_wrap .cmsmasters_sitemap > li:before {
		" . cmsmasters_color_css('background-color', $cmsmasters_option['green-farm' . '_' . $scheme . '_border']) . "
	}
	...
	{$rule}.owl-pagination .owl-page {
		" . cmsmasters_color_css('border-color', $cmsmasters_option['green-farm' . '_' . $scheme . '_border']) . "
	}
	...
	{$rule}.post.cmsmasters_post_puzzle .puzzle_post_content_wrapper {
		-webkit-box-shadow:inset 0 0 0 1px " . $cmsmasters_option['green-farm' . '_' . $scheme . '_border'] . ";
		box-shadow:inset 0 0 0 1px " . $cmsmasters_option['green-farm' . '_' . $scheme . '_border'] . ";
	}
	...
	/* Start Custom Rules */
	{$rule}::selection {
		" . cmsmasters_color_css('background', $cmsmasters_option['green-farm' . '_' . $scheme . '_link']) . "
		" . cmsmasters_color_css('color', $cmsmasters_option['green-farm' . '_' . $scheme . '_bg']) . ";
	}
	...
	if ($scheme != 'default') {
		...
		.cmsmasters_color_scheme_{$scheme}.cmsmasters_row_bot_zigzag:after {
			background-image: -webkit-linear-gradient(135deg, " . $cmsmasters_option['green-farm' . '_' . $scheme . '_bg'] . " 25%, transparent 25%), 
					-webkit-linear-gradient(45deg, " . $cmsmasters_option['green-farm' . '_' . $scheme . '_bg'] . " 25%, transparent 25%);
			background-image: -moz-linear-gradient(135deg, " . $cmsmasters_option['green-farm' . '_' . $scheme . '_bg'] . " 25%, transparent 25%), 
					-moz-linear-gradient(45deg, " . $cmsmasters_option['green-farm' . '_' . $scheme . '_bg'] . " 25%, transparent 25%);
			background-image: -ms-linear-gradient(135deg, " . $cmsmasters_option['green-farm' . '_' . $scheme . '_bg'] . " 25%, transparent 25%), 
					-ms-linear-gradient(45deg, " . $cmsmasters_option['green-farm' . '_' . $scheme . '_bg'] . " 25%, transparent 25%);
			background-image: -o-linear-gradient(135deg, " . $cmsmasters_option['green-farm' . '_' . $scheme . '_bg'] . " 25%, transparent 25%), 
					-o-linear-gradient(45deg, " . $cmsmasters_option['green-farm' . '_' . $scheme . '_bg'] . " 25%, transparent 25%);
			background-image: linear-gradient(315deg, " . $cmsmasters_option['green-farm' . '_' . $scheme . '_bg'] . " 25%, transparent 25%), 
					linear-gradient(45deg, " . $cmsmasters_option['green-farm' . '_' . $scheme . '_bg'] . " 25%, transparent 25%);
		}
		";
	}
...
/***************** Start {$title} Button Color Scheme Rules ******************/
	...
	{$rule}.cmsmasters_button.cmsmasters_but_icon_divider:after {
		" . cmsmasters_color_css('border-right-color', $cmsmasters_option['green-farm' . '_' . $scheme . '_bg']) . "
	}
...
";
	...
	return apply_filters('green_farm_theme_colors_primary_filter', $custom_css);
}
