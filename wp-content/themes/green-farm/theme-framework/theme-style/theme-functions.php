...
function green_farm_register_theme_js_scripts() {
	...
	wp_localize_script('green-farm-theme-script', 'cmsmasters_theme_script', $cmsmasters_localize_array);
}

add_action('wp_enqueue_scripts', 'green_farm_register_theme_js_scripts');



/* Register Theme Navigations */
register_nav_menus(array( 
    'primary' => 	esc_html__('Primary Navigation', 'green-farm'), 
    'footer' => 	esc_html__('Footer Navigation', 'green-farm'), 
	'top_line' => 	esc_html__('Top Line Navigation', 'green-farm') 
));
...
function green_farm_fallback_menu($args) {
	$cmsmasters_option = green_farm_get_global_options();
	...
	echo '<div class="navigation_wrap">' . "\n" . 
		'<ul id="navigation" class="' . 
			'navigation ' . 
			($cmsmasters_option['green-farm' . '_header_styles'] == 'default' ? 'mid_nav' : 'bot_nav') . 
		'">' . "\n";
...
function green_farm_single_project_layout($cmsmasters_layout) {
	if (
		is_singular('project') || 
		is_singular('profile') 
	) {
...
add_filter('cmsmasters_theme_page_layout_filter', 'green_farm_single_project_layout');



/* Search Form */
function green_farm_search_form($form) {
	$form = "<div class=\"search_bar_wrap\">
		<form method=\"get\" action=\"" . esc_url(home_url('/')) . "\">
			<p class=\"search_field\">
				<input name=\"s\" placeholder=\"" . esc_attr__('Search...', 'green-farm') . "\" value=\"\" type=\"search\" />
			</p>
...
add_filter('get_search_form', 'green_farm_search_form');
