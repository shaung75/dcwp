	...
	blogContainer.find('.cmsmasters_post_loader').on('click', function () { 
		...
		jQuery.ajax( { 
			...
			success : function (data) { 
				if (data !== '') {
					var newHTML = jQuery(data.replace(/cmsmasters_post_timeline/g, 'cmsmasters_post_timeline shortcode_animated').replace(/cmsmasters_post_masonry/g, 'cmsmasters_post_masonry shortcode_animated').replace(/cmsmasters_post_puzzle/g, 'cmsmasters_post_puzzle shortcode_animated')), 
						lightboxVars = [];
