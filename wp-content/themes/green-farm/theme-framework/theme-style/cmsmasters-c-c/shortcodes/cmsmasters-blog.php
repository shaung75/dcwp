...
$more_text = ($more_text != '') ? $more_text : esc_html__('Load More Posts', 'green-farm');


$filter_text = ($filter_text != '') ? $filter_text : esc_html__('Filter', 'green-farm');


$filter_cats_text = ($filter_cats_text != '') ? $filter_cats_text : esc_html__('All Categories', 'green-farm');
