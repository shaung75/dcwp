...
/* Filter for Options */
function green_farm_theme_meta_fields($custom_all_meta_fields) {
	...
	if (
		...
		foreach ($custom_all_meta_fields as $custom_all_meta_field) {
			if ($custom_all_meta_field['id'] == 'cmsmasters_project_columns') {
				...
				$options_field = array( 
					'four' => array(
						'label' => esc_html__('Four', 'green-farm'), 
						'value'	=> 'four' 
					)
				);
				...
				$custom_all_meta_fields_new[] = array( 
					...
					'desc'	=> esc_html__("Enter the 'Read More' button text that should be used in your portfolio shortcode", 'green-farm'), 
					'id'	=> 'cmsmasters_project_read_more', 
					'type'	=> 'text', 
					'hide'	=> '', 
					'std'	=> esc_html__('Learn More...', 'green-farm') 
				);
			} else {
				$custom_all_meta_fields_new[] = $custom_all_meta_field;
			}
...
add_filter('get_custom_all_meta_fields_filter', 'green_farm_theme_meta_fields');
