...
if ($cmsmasters_option['green-farm' . '_header_top_line']) {
	echo '<div class="header_top" data-height="' . esc_attr($cmsmasters_option['green-farm' . '_header_top_height']) . '">' . 
		'<div class="header_top_outer">' . 
			'<div class="header_top_inner">';
				...
				if (
					$cmsmasters_option['green-farm' . '_header_top_line_add_cont'] !== 'none'
				) {
					echo '<div class="header_top_right">';
					
					
					if (
						$cmsmasters_option['green-farm' . '_header_top_line_add_cont'] == 'social' && 
						isset($cmsmasters_option['green-farm' . '_social_icons'])
					) {
						green_farm_social_icons();
					} elseif (
						$cmsmasters_option['green-farm' . '_header_top_line_add_cont'] == 'nav' && 
				...
				if ($cmsmasters_option['green-farm' . '_header_top_line_short_info'] !== '') {
					echo '<div class="header_top_left">' . 
						'<div class="meta_wrap">' . 
							stripslashes($cmsmasters_option['green-farm' . '_header_top_line_short_info']) . 
						'</div>' . 
					'</div>';
				}
