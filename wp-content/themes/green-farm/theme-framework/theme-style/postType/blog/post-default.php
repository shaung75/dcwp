...
<article id="post-<?php the_ID(); ?>" <?php post_class('cmsmasters_post_default'); ?>>
	...
	<?php
		$date ? green_farm_get_post_date('page', 'default') : '';
		...
		if ($cmsmasters_post_format == 'image') {
			...
			green_farm_post_type_slider(get_the_ID(), $cmsmasters_post_images, 'post-thumbnail');
			...
			green_farm_thumb(get_the_ID(), 'post-thumbnail', true, false, false, false, false, true, false);
		}
