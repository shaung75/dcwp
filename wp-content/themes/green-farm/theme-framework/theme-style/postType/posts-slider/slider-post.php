...
$excerpt = (in_array('excerpt', $cmsmasters_metadata) && green_farm_slider_post_check_exc_cont('post')) ? true : false;
...
<article id="post-<?php the_ID(); ?>" <?php post_class('cmsmasters_slider_post'); ?>>
	...
	<?php
		$date ? green_farm_get_slider_post_date('post') : '';
		
		$title ? green_farm_slider_post_heading(get_the_ID(), 'post', 'h2') : '';
			...
			echo '<div class="cmsmasters_slider_post_inner">';
				...
				if ($likes || $comments) {
					echo '<footer class="cmsmasters_slider_post_footer entry-meta">';
						...
						$likes ? green_farm_slider_post_like('post') : '';
						
						$comments ? green_farm_get_slider_post_comments('post') : '';
				...
				if ($author || $categories) {
					echo '<div class="cmsmasters_slider_post_cont_info entry-meta">';
						...
						$author ? green_farm_get_slider_post_author('post') : '';
						
						$categories ? green_farm_get_slider_post_category(get_the_ID(), 'category', 'post') : '';
		...
		green_farm_thumb_rollover(get_the_ID(), 'cmsmasters-blog-masonry-thumb', false, false, false, false, false, false, false, false, true, false, false);
		
		$excerpt ? green_farm_slider_post_exc_cont('post') : '';
		
		$more ? green_farm_slider_post_more(get_the_ID()) : '';
