...
<article id="post-<?php the_ID(); ?>" <?php post_class('cmsmasters_profile_horizontal ' . $columns_num); ?>>
	...
	if (has_post_thumbnail()) {
		echo '<div class="cmsmasters_profile_img_wrap">';
			...
			green_farm_thumb_rollover(get_the_ID(), 'cmsmasters-square-thumb', false, true, false, false, false, false, false, false, true);
	...
	echo '<div class="profile_inner">';
		...
		green_farm_profile_heading(get_the_ID(), 'h3', $cmsmasters_profile_subtitle, 'h4', true, 'horizontal');
		
		green_farm_profile_exc_cont();
		
		green_farm_profile_social_icons($cmsmasters_profile_social, $profile_id);
